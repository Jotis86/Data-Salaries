...
def home_page():
    ...
    st.markdown("""
    <style>
        /* Hero section styling - same for both themes */
        .hero-container {
        ...
        /* Light theme */
        .stApp[data-theme="light"] .custom-header {
            color: #1E3A8A;
        }
        ...
        .stApp[data-theme="light"] .info-card:hover {
            box-shadow: 0 6px 15px rgba(0, 0, 0, 0.1);
        }
        .stApp[data-theme="light"] .card-title {
            color: #1E3A8A;
        }
        .stApp[data-theme="light"] .styled-list li {
            color: #333333;
        }
        ...
        .stApp[data-theme="light"] .limitations-title {
            color: #303F9F;
        }
        ...
        /* Dark theme */
        .stApp[data-theme="dark"] .custom-header {
            color: #90CAF9;
        }
        ...
        .stApp[data-theme="dark"] .info-card:hover {
            box-shadow: 0 6px 15px rgba(0, 0, 0, 0.4);
        }
        .stApp[data-theme="dark"] .card-title {
            color: #90CAF9;
        }
        .stApp[data-theme="dark"] .styled-list li {
            color: #e0e0e0;
        }
        ...
        .stApp[data-theme="dark"] .limitations-title {
            color: #C5CAE9;
        }
